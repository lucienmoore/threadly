import {
  ...
  y
} from "./chunk-OXTG5ME6.js";
import "./chunk-OMR6GRNR.js";
import {
  __commonJS,
  __toESM
...
var H2 = class {
  ...
  async read(e3) {
    this.file = await function(e4, t3) {
      return "string" == typeof e4 ? k(e4, t3) : s && !i && e4 instanceof HTMLImageElement ? k(e4.src, t3) : e4 instanceof Uint8Array || e4 instanceof ArrayBuffer || e4 instanceof DataView ? new c(e4) : s && e4 instanceof Blob ? O(e4, t3, "blob", A) : void l2("Invalid input argument");
    }(e3, this.options);
  }
  setup() {
    if (this.fileParser)
...
var J = class {
  ...
  translateBlock(e3, t3) {
    let s3 = I.get(t3), i3 = V.get(t3), n2 = B.get(t3), r3 = this.options[t3], a3 = r3.reviveValues && !!s3, h3 = r3.translateValues && !!i3, f3 = r3.translateKeys && !!n2, l4 = {};
    for (let [t4, r4] of e3)
      a3 && s3.has(t4) ? r4 = s3.get(t4)(r4) : h3 && i3.has(t4) && (r4 = this.translateValue(r4, i3.get(t4))), f3 && n2.has(t4) && (t4 = n2.get(t4) || t4), l4[t4] = r4;
    return l4;
  }
...
var ee = class extends class {
  ...
  findAppSegmentsInRange(e3, t3) {
    t3 -= 2;
    let s3, i3, n2, r3, a3, h3, { file: f3, findAll: l4, wanted: o3, remaining: u3, options: d3 } = this;
    for (; e3 < t3; e3++)
      if (255 === f3.getUint8(e3)) {
        if (s3 = f3.getUint8(e3 + 1), Q(s3)) {
          if (i3 = f3.getUint16(e3 + 2), n2 = Z(f3, e3, i3), n2 && o3.has(n2) && (r3 = y2.get(n2), a3 = r3.findPosition(f3, e3), h3 = d3[n2], a3.type = n2, this.appSegments.push(a3), !l4 && (r3.multiSegment && h3.multiSegment ? (this.unfinishedMultiSegment = a3.chunkNumber < a3.chunkCount, this.unfinishedMultiSegment || u3.delete(n2)) : u3.delete(n2), 0 === u3.size)))
            break;
...
var se = class extends J {
  ...
  parseTags(e3, t3, s3 = /* @__PURE__ */ new Map()) {
    ...
    i3 = new Set(i3);
    let r3 = i3.size > 0, a3 = 0 === n2.size, h3 = this.chunk.getUint16(e3);
    e3 += 2;
    for (let f3 = 0; f3 < h3; f3++) {
      ...
      if (r3) {
        ...
        !a3 && n2.has(h4) || s3.set(h4, this.parseTag(e3, h4, t3));
      e3 += 12;
    }
    return s3;
  }
...
var PriorityQueue = class {
  ...
  enqueue(run, options) {
    ...
    const index = lowerBound(__classPrivateFieldGet(this, _PriorityQueue_queue, "f"), element, (a3, b3) => b3.priority - a3.priority);
...
function p2(n2) {
  return o2 = 1, y3(D2, n2);
}
function y3(n2, u3, i3) {
  var o3 = h2(t2++, 2);
...
var Breadcrumbs_default = (props) => {
  ...
  }, breadcrumbsIcon), breadcrumbs.map((directory, i3) => y(Breadcrumb, {
    key: directory.id,
    getFolder: () => getFolder(directory.requestPath),
    title: i3 === 0 ? title : directory.name,
    isLast: i3 + 1 === breadcrumbs.length
  })));
};
...
function SearchFilterInput(props) {
  ...
  const [searchText, setSearchText] = p2(searchTerm != null ? searchTerm : "");
  const validateAndSearch = x2((ev) => {
    ev.preventDefault();
    search(searchText);
  }, [search, searchText]);
  const handleInput = x2((ev) => {
...
function ListItem2(props) {
  ...
  if (f3.isFolder) {
    ...
    return Item_default({
      ...
      title: f3.name,
      getItemIcon: () => f3.icon,
      isChecked: isChecked(f3),
      toggleCheckbox: (event) => toggleCheckbox(event, f3),
      recordShiftKeyPress,
      type: "folder",
      isDisabled: (_isChecked = isChecked(f3)) == null ? void 0 : _isChecked.loading,
      isCheckboxDisabled: f3.id === VIRTUAL_SHARED_DIR,
      handleFolderClick: () => getNextFolder(f3)
    });
  }
  const restrictionError = validateRestrictions(remoteFileObjToLocal(f3), [...uppyFiles, ...currentSelection]);
  return Item_default({
    id: f3.id,
    title: f3.name,
    author: f3.author,
    ...
    i18n,
    type: "file",
    isDisabled: restrictionError && !isChecked(f3),
    restrictionError
  });
}
...
var View = class {
  constructor(plugin, opts) {
    ...
    this.recordShiftKeyPress = (e3) => {
      this.isShiftKeyPressed = e3.shiftKey;
    };
    this.toggleCheckbox = (e3, file) => {
      e3.stopPropagation();
      e3.preventDefault();
...
var ProviderView = class extends View {
  ...
  async getFolder(requestPath, name) {
    ...
    try {
      await _classPrivateFieldLooseBase2(this, _withAbort)[_withAbort](async (signal) => {
        ...
        do {
          const {
            files: newFiles,
            folders: newFolders
          } = await _classPrivateFieldLooseBase2(this, _listFilesAndFolders)[_listFilesAndFolders]({
            breadcrumbs,
            signal
          });
          ...
          if (selectedItem.isFolder) {
            ...
            const onFiles = (files) => {
              for (const newFile of files) {
                ...
                const id5 = getSafeFileId(tagFile);
            ...
            await _classPrivateFieldLooseBase2(this, _recursivelyListAllFiles)[_recursivelyListAllFiles]({
              requestPath,
...
async function _withAbort2(op) {
  ...
  (_classPrivateFieldLoo = _classPrivateFieldLooseBase2(this, _abortController)[_abortController]) == null ? void 0 : _classPrivateFieldLoo.abort();
...
async function _listFilesAndFolders2(_ref2) {
  ...
  const {
    items,
    nextPagePath
  } = await _classPrivateFieldLooseBase2(this, _list)[_list]({
...
async function _recursivelyListAllFiles2(_ref3) {
  ...
  while (curPath) {
    const res = await _classPrivateFieldLooseBase2(this, _list)[_list]({
      requestPath: curPath,
      absDirPath,
      signal
    });
    ...
    onFiles(files);
    const promises = folders.map(async (folder) => queue.add(async () => _classPrivateFieldLooseBase2(this, _recursivelyListAllFiles)[_recursivelyListAllFiles]({
...
function FileCard(props) {
  ...
  const [formState, setFormState] = p2(storedMetaData);
  const handleSave = x2((ev) => {
    ev.preventDefault();
...
var Slide = class extends b {
  ...
  componentWillUpdate(nextProps) {
    ...
    const child = H(nextProps.children)[0];
