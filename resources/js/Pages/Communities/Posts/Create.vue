<template>
  <Head title="Создание треда" />

  <AuthenticatedLayout>
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto bg-white m-2 p-6">
          <h1 class="text-xl font-bold text-center mb-6 py-2 rounded-md bg-gradient-to-r from-blue-600 to-purple-700 text-white shadow-md">Создание треда</h1>
